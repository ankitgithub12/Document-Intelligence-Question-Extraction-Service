...
async def get_analytics_summary(
    ...
    return {
        ...
        "data": {
            ...
            "telemetry": {
                "ai_model": getattr(settings, "AI_MODEL", None) or "nvidia/nemotron-3.5-lightning:free",
                "ai_status": "ONLINE" if bool(getattr(settings, "AI_API_KEY", None)) else "STANDBY",
                "heuristic_fallback": "ACTIVE",
                "database": "CONNECTED",
                "redis_broker": "CONNECTED",
                "storage_provider": getattr(settings, "STORAGE_PROVIDER", "cloudinary"),
